	...
	static class MyATMThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				semaphore.acquire();
				System.out.println(name + " : got the permit! Available Semaphore permits now: "
								+ semaphore.availablePermits());
				...
				try {
					...
					System.out.println(name + " : releasing lock. Available Semaphore permits now: "
								+ semaphore.availablePermits());
					semaphore.release();
					System.out.println(name + " : Released. Available Semaphore permits now: "
								+ semaphore.availablePermits());
